...
config.General.requestName = 'JetData-March2016-Run2016B_TopAnalysis-v3'
config.General.workArea = 'JetData-March2016-Run2016B_TopAnalysis-v3'

config.section_("JobType")
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'flatData-Crab-cfg.py'
