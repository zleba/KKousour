...
SAMPLES = [
  ...
  "/ttHJetTobb_M125_13TeV_amcatnloFXFX_madspin_pythia8/RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9_ext3-v1/MINIAODSIM"
]
pset = ""
for ss in SAMPLES:
  if ss.find('TuneCUETP8M1')>0:
    ...
    tag = (ss.split("_13TeV_")[0]).replace("/","")
