...
#  fileNames = cms.untracked.vstring('root://eoscms//eos/cms/store/cmst3/user/cmgtools/CMG/BJetPlusX/Run2012B-22Jan2013-v1/AOD/#PAT_CMG_V5_17_0/cmgTuple_2105.root')
#)

process.source = datasetToSource('cmgtools','/BJetPlusX/Run2012D-22Jan2013-v1/AOD/PAT_CMG_V5_17_0','cmgTuple_.*.root')
...
process.Hbb = cms.EDAnalyzer('VbfHbbFlatTreeProducer',
    ...
    forceNOM         = cms.untracked.bool(True),
