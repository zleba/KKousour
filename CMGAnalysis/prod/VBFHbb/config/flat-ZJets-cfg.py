...
process.source = datasetToSource('cmgtools','/ZJetsFullyHadronic_Ht100_Pt50_Pt30_deta22_Mqq200_8TeV-madgraph/Summer12_DR53X-PU_S10_START53_V7C-v1/AODSIM/V5_B/PAT_CMG_V5_17_0','cmgTuple_.*.root')
...
process.Hbb = cms.EDAnalyzer('VbfHbbFlatTreeProducer',
  ...
  savePartons      = cms.untracked.bool(False),
  ## trigger ###################################
